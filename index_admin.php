...
<body>
    <section class="hero-section">
        <div class="hero-content">
            <h1 class="hero-title">Welcome, <?php echo ucfirst($role); ?>!</h1>
                            ...
                            <div class="product-content">
                                ...
                                <?php if($role === 'admin'): ?>
                                    <div class="product-actions">
                                        <a href="admin/edit_product.php?id=<?= $row['id'] ?>" class="btn-view"><i class="fas fa-edit"></i> Edit Product</a>
                                    </div>
                                <?php elseif($role === 'farmer'): ?>
                                    <div class="product-actions">
                                        <a href="farmer/products.php" class="btn-view"><i class="fas fa-box"></i> Manage My Products</a>
                                    </div>
                                <?php elseif($role === 'wholesaler'): ?>
                                    <div class="product-actions">
