...
<body>
    <section class="hero-section">
        <div class="hero-content">
            <h1 class="hero-title">Welcome, Wholesaler!</h1>
            <p class="hero-subtitle">Bulk orders and special pricing for wholesalers. Farm-fresh tubers delivered straight to your business.</p>
    ...
    <section class="products-section">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title">Bulk Products</h2>
                <p class="section-description">Order in bulk and get special pricing for your business needs.</p>
            </div>
            <div class="products-grid" id="productsGrid">
                    ...
                    <?php foreach ($rows as $index => $row): ?>
                        <div class="product-card" style="animation-delay: <?= ($index * 0.1) ?>s;">
                            ...
                            <div class="product-content">
                                ...
                                <p class="product-description">Bulk, organic <?= strtolower(htmlspecialchars($row['title'])) ?> sourced directly from local farms. Perfect for your business needs.</p>
                                ...
                                <div class="product-actions">
                                    ...
                                    <form action="cart_add.php" method="POST" class="add-to-cart-form">
                                        ...
                                        <button type="submit" class="btn-add-cart"><i class="fas fa-shopping-cart"></i></button>
                                    </form>
                                </div>
                            </div>
                        </div>
                ...
                <?php else: ?>
                    <div class="no-products">
                        ...
                        <p>Contact us for bulk orders and special pricing!</p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
